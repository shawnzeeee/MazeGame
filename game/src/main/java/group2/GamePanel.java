...
public class GamePanel extends JPanel implements Runnable {
    ...
    /**
     * This function spawns the enemy from the map generated in the board class.
     * Each number is associated with its respective entity
     */
    ...
    /**
     * This function takes in the graphics2D object to spawn the dialogue within the
     * dialogue window
     * 
     * @param g2
     */
    ...
    /**
     * This function draws the dialogue window itself with its position coordinates
     * and dimensions as arguments
     * 
     * @param x
     * @param y
     * @param width
    ...
    /**
     * This function draws each of the entities that was spawned through
     * initializeEntities()
     */
